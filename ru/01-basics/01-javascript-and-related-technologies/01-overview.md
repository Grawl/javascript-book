...
# Обзор: JavaScript, Flash, Java, Silverlight и ActiveX 

Итак, что же такого особенного в JavaScript, почему JavaScript и какие есть ещё полезные технологии.
...
<b>JavaScript это язык сценариев, созданный для оживления html-ставниц</b>. Он делает сеть чем-то большим, нежели просто страницы, связанные ссылками между собой.
